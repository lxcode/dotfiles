...
path=( /usr/bin /bin /usr/sbin /sbin /usr/local/bin /usr/local/sbin /var/qmail/bin $X11HOME/bin /usr/local/9/bin /crypt/usr/local/texlive/2015/bin/amd64-freebsd /usr/texbin ~/bin ~/android/tools /home/lx/tools/graudit /usr/local/libexec/git-core )
