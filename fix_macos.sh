...
brew doctor
brew install task tmux w3m apg bvi cscope daemontools djbdns runit mutt nvi nmap par python3 weechat wireshark youtube-dl bbe zsh vdirsyncer khal ag fzf mosh tree ripgrep
